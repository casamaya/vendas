 ...
 * @author sam
 */
public class ObsAtendimentoEditPanel extends EditPanel {

    /** Creates new form ObservacaoEditPanel */
    public ObsAtendimentoEditPanel() {
        initComponents();
    }

    @Override
    public void object2Field(Object obj) {
        Pedido pgto = (Pedido) obj;
        obsTextArea.setText(pgto.getObsAtendimento());
    }

    @Override
    public void field2Object(Object obj) {
        Pedido pgto = (Pedido) obj;
        pgto.setObsAtendimento(obsTextArea.getText());
    }
